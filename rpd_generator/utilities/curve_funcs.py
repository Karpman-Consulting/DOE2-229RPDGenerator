...
def are_curve_outputs_all_equal_to_a_value_of_one(
    ...
    is_cap_ft_within_margin = is_within_margin(
        result_cap_ft, 1, percent_margin_of_error
    )
    is_eff_ft_within_margin = is_within_margin(
        result_eff_ft, 1, percent_margin_of_error
    )
    is_eff_plr_within_margin = is_within_margin(
        result_eff_plr, 1, percent_margin_of_error
    )

    all_within_margin = all(
        [is_cap_ft_within_margin, is_eff_ft_within_margin, is_eff_plr_within_margin]
    )
