...
class TestZones(unittest.TestCase):
    def setUp(self):
        ...
        self.people_annual_schedule.annual_calendar = generated_calendar
        self.temp_reset_annual_schedule.annual_calendar = generated_calendar
        self.flow_annual_schedule.annual_calendar = generated_calendar
        self.thermostat_annual_schedule.annual_calendar = generated_calendar
        ...
        self.people_day_schedule.keyword_value_pairs = {
            ...
            BDL_DayScheduleKeywords.VALUES: ["0.1" for i in range(24)],
        }
        self.people_week_schedule.keyword_value_pairs = {
            ...
            BDL_WeekScheduleKeywords.DAY_SCHEDULES: [
                "People Day Schedule" for i in range(12)
            ],
        }
        ...
        self.flow_day_schedule.keyword_value_pairs = {
            BDL_DayScheduleKeywords.TYPE: BDL_ScheduleTypes.FRAC_DESIGN,
            BDL_DayScheduleKeywords.VALUES: ["0.5" for i in range(24)],
        }
        self.flow_week_schedule.keyword_value_pairs = {
            BDL_WeekScheduleKeywords.TYPE: BDL_ScheduleTypes.FRAC_DESIGN,
            BDL_WeekScheduleKeywords.DAY_SCHEDULES: [
                "Flow Day Schedule" for i in range(12)
            ],
        }
        ...
        self.thermostat_week_schedule.keyword_value_pairs = {
            BDL_WeekScheduleKeywords.TYPE: BDL_ScheduleTypes.RESET_TEMP,
            BDL_WeekScheduleKeywords.DAY_SCHEDULES: [
                "Thermostat Day Schedule" for i in range(12)
            ],
        }
    ...
    def test_populate_zone_constant_volume_constant_temp_data(
        ...
        TODO: Currently zone.py doesn't have a path to handle constant temp for electric type heating.
        See roughly line 516 in system.py
        """
        mock_get_output_data.return_value = {
            "Supply Fan - Airflow": 0,
            "Supply Fan - Power": 0,
    ...
    def test_populate_zone_terminal_system_data(self, mock_get_output_data):
        ...
        TODO: Currently zone.py doesn't have a path to handle constant volume and constant temp
        control. See get_terminal_system_temperature_control and populate_main_terminal_type. Not sure what
    ...
    def test_populate_zone_with_dcv_prevented_by_min_oa_sch(self, mock_get_output_data):
        ...
        self.flow_day_schedule.keyword_value_pairs = {
            BDL_DayScheduleKeywords.TYPE: BDL_ScheduleTypes.FRAC_DESIGN,
            BDL_DayScheduleKeywords.VALUES: ["-999" for i in range(24)],
        }
        self.zone.keyword_value_pairs = {
            BDL_ZoneKeywords.BASEBOARD_CTRL: BDL_BaseboardControlOptions.NONE,
            BDL_ZoneKeywords.DESIGN_COOL_T: "85",
